...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-components-spaceui-c-notification-list-1": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/notification-list/c-notification-list-1/index.tsx"),
    {},
  ),
};
