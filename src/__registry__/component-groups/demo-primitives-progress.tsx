...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-p-progress-01": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/progress/p-progress-01/index.tsx"),
    {},
  ),
  "demo-p-progress-02": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/progress/p-progress-02/index.tsx"),
    {},
  ),
  "demo-p-progress-03": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/progress/p-progress-03/index.tsx"),
    {},
  ),
};
