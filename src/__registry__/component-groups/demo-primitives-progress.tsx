...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-primitives-p-progress-1': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/progress/p-progress-1/index.tsx'),
    {},
  ),
  'demo-primitives-p-progress-2': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/progress/p-progress-2/index.tsx'),
    {},
  ),
  'demo-primitives-p-progress-3': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/progress/p-progress-3/index.tsx'),
    {},
  ),
}
