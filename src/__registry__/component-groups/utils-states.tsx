...
export const registryComponents: Record<string, RegistryComponent> = {
  'hooks-utils-states-catch-error': lazyRegistryComponent(
    () => import('@/registry/utils/states/catch-error/index.ts'),
    {},
  ),
  'hooks-utils-states-create-error': lazyRegistryComponent(
    () => import('@/registry/utils/states/create-error/index.ts'),
    {},
  ),
}
