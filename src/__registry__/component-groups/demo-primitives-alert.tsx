...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-p-alert-01': lazyRegistryComponent(() => import('@/registry/demo/primitives/alert/p-alert-01/index.tsx'), {}),
  'demo-p-alert-02': lazyRegistryComponent(() => import('@/registry/demo/primitives/alert/p-alert-02/index.tsx'), {}),
  'demo-p-alert-03': lazyRegistryComponent(() => import('@/registry/demo/primitives/alert/p-alert-03/index.tsx'), {}),
  'demo-p-alert-04': lazyRegistryComponent(() => import('@/registry/demo/primitives/alert/p-alert-04/index.tsx'), {}),
}
