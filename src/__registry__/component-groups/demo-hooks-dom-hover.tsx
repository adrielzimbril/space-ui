...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-hooks-dom-hover-1": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/dom/hover/h-hover-1/index.tsx"),
    {},
  ),
  "demo-hooks-dom-hover-2": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/dom/hover/h-hover-2/index.tsx"),
    {},
  ),
};
