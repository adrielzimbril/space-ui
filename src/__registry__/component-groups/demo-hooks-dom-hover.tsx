...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-h-hover-01': lazyRegistryComponent(() => import('@/registry/demo/hooks/dom/hover/h-hover-01/index.tsx'), {}),
  'demo-h-hover-02': lazyRegistryComponent(() => import('@/registry/demo/hooks/dom/hover/h-hover-02/index.tsx'), {}),
}
