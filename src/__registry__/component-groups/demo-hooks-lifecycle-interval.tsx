...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-hooks-lifecycle-interval-1": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/lifecycle/interval/h-interval-1/index.tsx"),
    {},
  ),
  "demo-hooks-lifecycle-interval-2": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/lifecycle/interval/h-interval-2/index.tsx"),
    {},
  ),
};
