...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-h-interval-01": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/lifecycle/interval/h-interval-01/index.tsx"),
    {},
  ),
  "demo-h-interval-02": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/lifecycle/interval/h-interval-02/index.tsx"),
    {},
  ),
};
