...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-components-shader-c-cloud-1": lazyRegistryComponent(
    () => import("@/registry/demo/components/shader/cloud/c-cloud-1/index.tsx"),
    {"speed":{"value":1,"min":0,"max":5,"step":0.1},"sky":{"value":"#68b8d7"},"cloudColor":{"value":"#adc1de"},"shadow":{"value":"#183550"},"sun":{"value":"#ff9919"},"glare":{"value":"#ff6633"},"sunlight":{"value":"#ff9933"},"bg":{"value":"#ffffff"}},
  ),
};
