...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-hooks-animation-auto-height-1': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/animation/auto-height/h-auto-height-1/index.tsx'),
    {},
  ),
  'demo-hooks-animation-auto-height-2': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/animation/auto-height/h-auto-height-2/index.tsx'),
    {},
  ),
}
