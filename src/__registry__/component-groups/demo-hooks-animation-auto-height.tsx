...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-h-auto-height-01': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/animation/auto-height/h-auto-height-01/index.tsx'),
    {},
  ),
  'demo-h-auto-height-02': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/animation/auto-height/h-auto-height-02/index.tsx'),
    {},
  ),
}
