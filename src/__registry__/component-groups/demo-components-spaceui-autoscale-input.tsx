...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-components-spaceui-c-autoscale-input-1": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/autoscale-input/c-autoscale-input-1/index.tsx"),
    {},
  ),
};
