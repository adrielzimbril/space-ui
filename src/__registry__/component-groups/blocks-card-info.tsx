...
export const registryComponents: Record<string, RegistryComponent> = {
  "block-card-info-1": lazyRegistryComponent(
    () => import("@/registry/blocks/card-info/card-info-1/index.tsx"),
    {},
  ),
  "block-card-info-2": lazyRegistryComponent(
    () => import("@/registry/blocks/card-info/card-info-2/index.tsx"),
    {},
  ),
};
