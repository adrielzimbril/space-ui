...
export const registryComponents: Record<string, RegistryComponent> = {
  'lib-base-ui': lazyRegistryComponent(() => import('@/registry/lib/base-ui/csp-provider/index.ts'), {}),
  'lib-base-ui-csp-provider': lazyRegistryComponent(() => import('@/registry/lib/base-ui/csp-provider/index.ts'), {}),
  'lib-base-ui-direction-provider': lazyRegistryComponent(
    () => import('@/registry/lib/base-ui/direction-provider/index.ts'),
    {},
  ),
  'lib-base-ui-merge-props': lazyRegistryComponent(() => import('@/registry/lib/base-ui/merge-props/index.ts'), {}),
  'lib-base-ui-use-render': lazyRegistryComponent(() => import('@/registry/lib/base-ui/use-render/index.ts'), {}),
}
