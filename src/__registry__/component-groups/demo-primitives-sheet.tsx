...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-primitives-p-sheet-1': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/sheet/p-sheet-1/index.tsx'),
    {},
  ),
  'demo-primitives-p-sheet-2': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/sheet/p-sheet-2/index.tsx'),
    {},
  ),
  'demo-primitives-p-sheet-3': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/sheet/p-sheet-3/index.tsx'),
    {},
  ),
}
