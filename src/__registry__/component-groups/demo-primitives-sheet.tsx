...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-p-sheet-01": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/sheet/p-sheet-01/index.tsx"),
    {},
  ),
  "demo-p-sheet-02": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/sheet/p-sheet-02/index.tsx"),
    {},
  ),
  "demo-p-sheet-03": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/sheet/p-sheet-03/index.tsx"),
    {},
  ),
};
