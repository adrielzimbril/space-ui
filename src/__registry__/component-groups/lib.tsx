...
export const registryComponents: Record<string, RegistryComponent> = {
  'lib-get-strict-context': lazyRegistryComponent(() => import('@/registry/lib/get-strict-context/index.tsx'), {}),
  'lib-segmented-control': lazyRegistryComponent(() => import('@/registry/lib/segmented-control/index.ts'), {}),
  'lib-utils': lazyRegistryComponent(() => import('@/registry/lib/utils/index.ts'), {}),
}
