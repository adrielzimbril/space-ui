...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-hooks-components-for-1': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/components/for/h-for-1/index.tsx'),
    {},
  ),
  'demo-hooks-components-for-2': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/components/for/h-for-2/index.tsx'),
    {},
  ),
}
