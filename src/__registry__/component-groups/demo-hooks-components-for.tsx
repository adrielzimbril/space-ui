...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-h-for-01": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/components/for/h-for-01/index.tsx"),
    {},
  ),
  "demo-h-for-02": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/components/for/h-for-02/index.tsx"),
    {},
  ),
};
