...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-p-command-01': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/command/p-command-01/index.tsx'),
    {},
  ),
  'demo-p-command-02': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/command/p-command-02/index.tsx'),
    {},
  ),
}
