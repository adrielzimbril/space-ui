...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-components-spaceui-c-tournament-bracket-1': lazyRegistryComponent(
    () => import('@/registry/demo/components/spaceui/tournament-bracket/c-tournament-bracket-1/index.tsx'),
    {},
  ),
}
