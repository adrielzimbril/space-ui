...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-primitives-p-form-1': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/form/p-form-1/index.tsx'),
    {},
  ),
  'demo-primitives-p-form-2': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/form/p-form-2/index.tsx'),
    {},
  ),
}
