...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-p-form-01': lazyRegistryComponent(() => import('@/registry/demo/primitives/form/p-form-01/index.tsx'), {}),
  'demo-p-form-02': lazyRegistryComponent(() => import('@/registry/demo/primitives/form/p-form-02/index.tsx'), {}),
}
