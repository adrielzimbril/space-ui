...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-hooks-form-file-upload-1': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/form/file-upload/h-file-upload-1/index.tsx'),
    {},
  ),
  'demo-hooks-form-file-upload-2': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/form/file-upload/h-file-upload-2/index.tsx'),
    {},
  ),
  'demo-hooks-form-file-upload-3': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/form/file-upload/h-file-upload-3/index.tsx'),
    {},
  ),
}
