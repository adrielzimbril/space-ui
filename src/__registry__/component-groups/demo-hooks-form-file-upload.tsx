...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-h-file-upload-01": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/form/file-upload/h-file-upload-01/index.tsx"),
    {},
  ),
  "demo-h-file-upload-02": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/form/file-upload/h-file-upload-02/index.tsx"),
    {},
  ),
  "demo-h-file-upload-03": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/form/file-upload/h-file-upload-03/index.tsx"),
    {},
  ),
};
