...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-components-spaceui-c-bouncy-accordion-1": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/bouncy-accordion/c-bouncy-accordion-1/index.tsx"),
    {},
  ),
};
