...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-hooks-utils-range-map-1': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/utils/range-map/h-range-map-1/index.tsx'),
    {},
  ),
  'demo-hooks-utils-range-map-2': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/utils/range-map/h-range-map-2/index.tsx'),
    {},
  ),
}
