...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-h-range-map-01": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/utils/range-map/h-range-map-01/index.tsx"),
    {},
  ),
  "demo-h-range-map-02": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/utils/range-map/h-range-map-02/index.tsx"),
    {},
  ),
};
