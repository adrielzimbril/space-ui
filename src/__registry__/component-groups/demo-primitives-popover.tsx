...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-primitives-p-popover-1': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/popover/p-popover-1/index.tsx'),
    {},
  ),
  'demo-primitives-p-popover-2': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/popover/p-popover-2/index.tsx'),
    {},
  ),
  'demo-primitives-p-popover-3': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/popover/p-popover-3/index.tsx'),
    {},
  ),
  'demo-primitives-p-popover-4': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/popover/p-popover-4/index.tsx'),
    {},
  ),
}
