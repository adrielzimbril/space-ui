...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-p-checkbox-01': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/checkbox/p-checkbox-01/index.tsx'),
    {},
  ),
  'demo-p-checkbox-02': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/checkbox/p-checkbox-02/index.tsx'),
    {},
  ),
  'demo-p-checkbox-03': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/checkbox/p-checkbox-03/index.tsx'),
    {},
  ),
  'demo-p-checkbox-04': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/checkbox/p-checkbox-04/index.tsx'),
    {},
  ),
}
