...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-p-skeleton-01": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/skeleton/p-skeleton-01/index.tsx"),
    {},
  ),
  "demo-p-skeleton-02": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/skeleton/p-skeleton-02/index.tsx"),
    {},
  ),
};
