...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-primitives-p-skeleton-1": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/skeleton/p-skeleton-1/index.tsx"),
    {},
  ),
  "demo-primitives-p-skeleton-2": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/skeleton/p-skeleton-2/index.tsx"),
    {},
  ),
};
