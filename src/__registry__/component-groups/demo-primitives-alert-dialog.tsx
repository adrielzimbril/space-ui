...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-p-alert-dialog-01': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/alert-dialog/p-alert-dialog-01/index.tsx'),
    {},
  ),
  'demo-p-alert-dialog-02': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/alert-dialog/p-alert-dialog-02/index.tsx'),
    {},
  ),
}
