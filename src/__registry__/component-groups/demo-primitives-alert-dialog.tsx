...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-primitives-p-alert-dialog-1": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/alert-dialog/p-alert-dialog-1/index.tsx"),
    {},
  ),
  "demo-primitives-p-alert-dialog-2": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/alert-dialog/p-alert-dialog-2/index.tsx"),
    {},
  ),
};
