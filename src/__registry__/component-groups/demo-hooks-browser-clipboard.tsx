...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-h-clipboard-01': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/clipboard/h-clipboard-01/index.tsx'),
    {},
  ),
  'demo-h-clipboard-02': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/clipboard/h-clipboard-02/index.tsx'),
    {},
  ),
  'demo-h-clipboard-03': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/clipboard/h-clipboard-03/index.tsx'),
    {},
  ),
}
