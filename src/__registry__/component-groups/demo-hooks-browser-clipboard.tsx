...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-hooks-browser-clipboard-1': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/clipboard/h-clipboard-1/index.tsx'),
    {},
  ),
  'demo-hooks-browser-clipboard-2': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/clipboard/h-clipboard-2/index.tsx'),
    {},
  ),
  'demo-hooks-browser-clipboard-3': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/clipboard/h-clipboard-3/index.tsx'),
    {},
  ),
}
