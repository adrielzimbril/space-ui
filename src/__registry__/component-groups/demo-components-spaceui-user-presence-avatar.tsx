...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-components-spaceui-c-user-presence-avatar-1': lazyRegistryComponent(
    () => import('@/registry/demo/components/spaceui/user-presence-avatar/c-user-presence-avatar-1/index.tsx'),
    {},
  ),
}
