...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-hooks-lifecycle-isomorphic-layout-effect-1": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/lifecycle/isomorphic-layout-effect/h-isomorphic-layout-effect-1/index.tsx"),
    {},
  ),
};
