...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-h-isomorphic-layout-effect-01': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/lifecycle/isomorphic-layout-effect/h-isomorphic-layout-effect-01/index.tsx'),
    {},
  ),
}
