...
export const registryComponents: Record<string, RegistryComponent> = {
  'components-orb-bloop': lazyRegistryComponent(() => import('@/registry/components/orb/bloop/index.tsx'), {}),
  'components-orb-smooth': lazyRegistryComponent(() => import('@/registry/components/orb/smooth/index.tsx'), {}),
}
