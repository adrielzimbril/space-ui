...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-p-meter-01': lazyRegistryComponent(() => import('@/registry/demo/primitives/meter/p-meter-01/index.tsx'), {}),
  'demo-p-meter-02': lazyRegistryComponent(() => import('@/registry/demo/primitives/meter/p-meter-02/index.tsx'), {}),
  'demo-p-meter-03': lazyRegistryComponent(() => import('@/registry/demo/primitives/meter/p-meter-03/index.tsx'), {}),
  'demo-p-meter-04': lazyRegistryComponent(() => import('@/registry/demo/primitives/meter/p-meter-04/index.tsx'), {}),
}
