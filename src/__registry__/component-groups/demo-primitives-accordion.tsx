...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-p-accordion-01": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/accordion/p-accordion-01/index.tsx"),
    {},
  ),
  "demo-p-accordion-02": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/accordion/p-accordion-02/index.tsx"),
    {},
  ),
  "demo-p-accordion-03": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/accordion/p-accordion-03/index.tsx"),
    {},
  ),
};
