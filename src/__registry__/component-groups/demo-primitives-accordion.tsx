...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-primitives-p-accordion-1": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/accordion/p-accordion-1/index.tsx"),
    {},
  ),
  "demo-primitives-p-accordion-2": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/accordion/p-accordion-2/index.tsx"),
    {},
  ),
  "demo-primitives-p-accordion-3": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/accordion/p-accordion-3/index.tsx"),
    {},
  ),
};
