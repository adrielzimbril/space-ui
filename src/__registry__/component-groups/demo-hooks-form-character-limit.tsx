...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-hooks-form-character-limit-1': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/form/character-limit/h-character-limit-1/index.tsx'),
    {},
  ),
  'demo-hooks-form-character-limit-2': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/form/character-limit/h-character-limit-2/index.tsx'),
    {},
  ),
}
