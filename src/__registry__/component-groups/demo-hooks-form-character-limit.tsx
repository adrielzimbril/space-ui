...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-h-character-limit-01': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/form/character-limit/h-character-limit-01/index.tsx'),
    {},
  ),
  'demo-h-character-limit-02': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/form/character-limit/h-character-limit-02/index.tsx'),
    {},
  ),
}
