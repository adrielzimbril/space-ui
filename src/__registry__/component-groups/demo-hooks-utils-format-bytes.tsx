...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-hooks-utils-format-bytes-1": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/utils/format-bytes/h-format-bytes-1/index.tsx"),
    {},
  ),
  "demo-hooks-utils-format-bytes-2": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/utils/format-bytes/h-format-bytes-2/index.tsx"),
    {},
  ),
};
