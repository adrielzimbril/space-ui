...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-h-format-bytes-01': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/utils/format-bytes/h-format-bytes-01/index.tsx'),
    {},
  ),
  'demo-h-format-bytes-02': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/utils/format-bytes/h-format-bytes-02/index.tsx'),
    {},
  ),
}
