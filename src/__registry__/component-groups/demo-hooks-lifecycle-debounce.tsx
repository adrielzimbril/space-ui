...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-hooks-lifecycle-debounce-1": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/lifecycle/debounce/h-debounce-1/index.tsx"),
    {},
  ),
  "demo-hooks-lifecycle-debounce-2": lazyRegistryComponent(
    () => import("@/registry/demo/hooks/lifecycle/debounce/h-debounce-2/index.tsx"),
    {},
  ),
};
