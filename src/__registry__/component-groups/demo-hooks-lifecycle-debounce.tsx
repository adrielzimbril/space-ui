...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-h-debounce-01': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/lifecycle/debounce/h-debounce-01/index.tsx'),
    {},
  ),
  'demo-h-debounce-02': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/lifecycle/debounce/h-debounce-02/index.tsx'),
    {},
  ),
}
