...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-components-spaceui-c-section-scrollspy-1": lazyRegistryComponent(
    () => import("@/registry/demo/components/spaceui/section-scrollspy/c-section-scrollspy-1/index.tsx"),
    {},
  ),
};
