...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-primitives-p-frame-1': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/frame/p-frame-1/index.tsx'),
    {},
  ),
  'demo-primitives-p-frame-2': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/frame/p-frame-2/index.tsx'),
    {},
  ),
  'demo-primitives-p-frame-3': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/frame/p-frame-3/index.tsx'),
    {},
  ),
  'demo-primitives-p-frame-4': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/frame/p-frame-4/index.tsx'),
    {},
  ),
}
