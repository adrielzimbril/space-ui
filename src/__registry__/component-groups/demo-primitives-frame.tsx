...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-p-frame-01": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/frame/p-frame-01/index.tsx"),
    {},
  ),
  "demo-p-frame-02": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/frame/p-frame-02/index.tsx"),
    {},
  ),
  "demo-p-frame-03": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/frame/p-frame-03/index.tsx"),
    {},
  ),
  "demo-p-frame-04": lazyRegistryComponent(
    () => import("@/registry/demo/primitives/frame/p-frame-04/index.tsx"),
    {},
  ),
};
