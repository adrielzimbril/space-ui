...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-h-switch-01': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/components/switch/h-switch-01/index.tsx'),
    {},
  ),
  'demo-h-switch-02': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/components/switch/h-switch-02/index.tsx'),
    {},
  ),
}
