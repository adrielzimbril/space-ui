...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-hooks-components-switch-1': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/components/switch/h-switch-1/index.tsx'),
    {},
  ),
  'demo-hooks-components-switch-2': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/components/switch/h-switch-2/index.tsx'),
    {},
  ),
}
