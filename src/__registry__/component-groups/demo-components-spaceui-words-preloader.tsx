...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-components-spaceui-c-words-preloader-1': lazyRegistryComponent(
    () => import('@/registry/demo/components/spaceui/words-preloader/c-words-preloader-1/index.tsx'),
    {},
  ),
}
