...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-p-pagination-01': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/pagination/p-pagination-01/index.tsx'),
    {},
  ),
  'demo-p-pagination-02': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/pagination/p-pagination-02/index.tsx'),
    {},
  ),
  'demo-p-pagination-03': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/pagination/p-pagination-03/index.tsx'),
    {},
  ),
}
