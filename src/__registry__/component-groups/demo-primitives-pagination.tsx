...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-primitives-p-pagination-1': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/pagination/p-pagination-1/index.tsx'),
    {},
  ),
  'demo-primitives-p-pagination-2': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/pagination/p-pagination-2/index.tsx'),
    {},
  ),
  'demo-primitives-p-pagination-3': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/pagination/p-pagination-3/index.tsx'),
    {},
  ),
}
