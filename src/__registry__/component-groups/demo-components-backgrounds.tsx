...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-c-backgrounds-bubble-01': lazyRegistryComponent(
    () => import('@/registry/demo/components/backgrounds/c-backgrounds-bubble-01/index.tsx'),
    {},
  ),
  'demo-c-backgrounds-gradient-01': lazyRegistryComponent(
    () => import('@/registry/demo/components/backgrounds/c-backgrounds-gradient-01/index.tsx'),
    {},
  ),
}
