...
export const registryComponents: Record<string, RegistryComponent> = {
  "demo-components-backgrounds-bubble": lazyRegistryComponent(
    () => import("@/registry/demo/components/backgrounds/bubble/index.tsx"),
    {},
  ),
  "demo-components-backgrounds-gradient": lazyRegistryComponent(
    () => import("@/registry/demo/components/backgrounds/gradient/index.tsx"),
    {},
  ),
};
