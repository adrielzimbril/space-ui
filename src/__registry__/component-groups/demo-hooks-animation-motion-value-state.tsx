...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-hooks-animation-motion-value-state-1': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/animation/motion-value-state/h-motion-value-state-1/index.tsx'),
    {},
  ),
}
