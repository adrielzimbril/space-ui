...
export const registryComponents: Record<string, RegistryComponent> = {
  'components-backgrounds-bubble': lazyRegistryComponent(
    () => import('@/registry/components/backgrounds/bubble/index.tsx'),
    {},
  ),
  'components-backgrounds-gradient': lazyRegistryComponent(
    () => import('@/registry/components/backgrounds/gradient/index.tsx'),
    {},
  ),
}
