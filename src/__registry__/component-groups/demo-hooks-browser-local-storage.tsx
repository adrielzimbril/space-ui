...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-h-local-storage-01': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/local-storage/h-local-storage-01/index.tsx'),
    {},
  ),
  'demo-h-local-storage-02': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/local-storage/h-local-storage-02/index.tsx'),
    {},
  ),
  'demo-h-local-storage-03': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/local-storage/h-local-storage-03/index.tsx'),
    {},
  ),
}
