...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-hooks-browser-local-storage-1': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/local-storage/h-local-storage-1/index.tsx'),
    {},
  ),
  'demo-hooks-browser-local-storage-2': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/local-storage/h-local-storage-2/index.tsx'),
    {},
  ),
  'demo-hooks-browser-local-storage-3': lazyRegistryComponent(
    () => import('@/registry/demo/hooks/browser/local-storage/h-local-storage-3/index.tsx'),
    {},
  ),
}
