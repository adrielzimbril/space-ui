...
export const registryComponents: Record<string, RegistryComponent> = {
  'demo-p-tooltip-01': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/tooltip/p-tooltip-01/index.tsx'),
    {},
  ),
  'demo-p-tooltip-02': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/tooltip/p-tooltip-02/index.tsx'),
    {},
  ),
  'demo-p-tooltip-03': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/tooltip/p-tooltip-03/index.tsx'),
    {},
  ),
  'demo-p-tooltip-04': lazyRegistryComponent(
    () => import('@/registry/demo/primitives/tooltip/p-tooltip-04/index.tsx'),
    {},
  ),
}
