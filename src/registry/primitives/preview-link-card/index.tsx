...
} from '@/registry/primitives/preview-card'
...
function PreviewLinkCardPopup({ href: hrefProp, style, children, ...props }: PreviewLinkCardPopupProps) {
  const { href } = usePreviewLinkCard()

  return (
    <PreviewCardPopupPrimitive data-slot="preview-link-card-popup" {...props}>
      <a
