...
export function CardFrameHeader({ className, render, ...props }: useRender.ComponentProps<'div'>): React.ReactElement {
  const defaultProps = {
    className: cn(
      'relative flex grid auto-rows-min grid-rows-[auto_auto] flex-col items-start gap-x-4 px-2 pt-1 has-data-[slot=card-frame-action]:grid-cols-[1fr_auto]',
      className,
    ),
