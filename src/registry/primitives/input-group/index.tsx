...
import { Input, type InputProps } from '@/registry/primitives/input'
import { Textarea, type TextareaProps } from '@/registry/primitives/textarea'
...
export function InputGroupButton({ className, ...props }: ButtonProps): React.ReactElement {
  return <Button className={cn(className)} data-slot="input-group-button" {...props} />
}
