...
function IconStack({ className, children, style, ...props }: IconStackProps) {
  return (
    <div
      ...
      className={cn('text-foreground **:data-[slot=icon-stack-layer]:fill-background relative h-20 w-18', className)}
      style={
        {
      ...
      {...props}
    >
      <svg aria-hidden="true" viewBox="0 0 72 81" fill="none" className="h-full w-full overflow-visible">
        <ellipse cx="36" cy="76" rx="30" ry="7" fill="currentColor" fillOpacity="0.055" className="blur-[4px]" />
