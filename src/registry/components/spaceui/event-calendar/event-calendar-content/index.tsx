...
import { EventCalendarAgendaView } from '@/registry/components/spaceui/event-calendar/event-calendar-agenda-view'
import { EventCalendarMonthView } from '@/registry/components/spaceui/event-calendar/event-calendar-month-view'
import { EventCalendarResourceView } from '@/registry/components/spaceui/event-calendar/event-calendar-resource-view'
import {
...
function EventCalendarContent({ className, render, components, children, ...props }: EventCalendarContentProps) {
