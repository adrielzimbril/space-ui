...
export default function Particle() {
  ...
  return (
    <Autocomplete items={manyTags} limit={limit} onValueChange={setValue} value={value}>
      ...
      <AutocompletePopup>
        ...
        {moreCount > 0 && <AutocompleteStatus>+{moreCount} more (keep typing to narrow down)</AutocompleteStatus>}
      </AutocompletePopup>
    </Autocomplete>
  )
}
