...
function TaskCard({
  ...
  asHandle,
  ...props
}: { task: Task; asHandle?: boolean } & Omit<ComponentProps<typeof KanbanItem>, 'value' | 'children'>) {
  const content = (
    <Frame variant="ghost" spacing="xs" className="p-0">
      <FramePanel className="space-y-3 p-3">
        <p className="text-sm font-medium">{task.title}</p>
        <Progress value={task.progress} className="[&_[data-slot=progress-track]]:h-1" />
    ...
    planning: [
      {
        ...
        assignee: 'Alex J.',
        assigneeAvatar: 'https://avatars.spaceui.one/v1?name=vega&variant=singularity',
        progress: 20,
      },
    ],
    active: [
      {
        ...
        assignee: 'Sarah C.',
        assigneeAvatar: 'https://avatars.spaceui.one/v1?name=sirius&variant=triton',
        progress: 65,
      },
      {
        id: '3',
        ...
        assignee: 'David K.',
        assigneeAvatar: 'https://avatars.spaceui.one/v1?name=nova&variant=solar-flare',
        progress: 40,
      },
    ],
    completed: [
      {
        ...
        assignee: 'Emma W.',
        assigneeAvatar: 'https://avatars.spaceui.one/v1?name=pulsar&variant=titan',
        progress: 100,
      },
    ],
  })
