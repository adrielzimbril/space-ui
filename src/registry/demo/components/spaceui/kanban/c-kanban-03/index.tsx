...
import { IconCircle, IconCircleDot, IconCircleCheck } from '@tabler/icons-react'
...
interface Task {
  ...
  title: string
  label: string
  labelVariant: 'primary-light' | 'success-light' | 'warning-light' | 'destructive-light' | 'info-light'
}
...
const COLUMNS: Record<string, { title: string; icon: React.ReactNode }> = {
  ...
  doing: {
    title: 'In Progress',
    icon: <IconCircleDot className="text-muted-foreground size-4" />,
  },
  done: {
    title: 'Done',
