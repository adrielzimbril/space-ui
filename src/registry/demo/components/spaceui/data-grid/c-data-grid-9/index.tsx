...
const demoData: Data[] = [
  {
    ...
    customerAvatar: 'https://avatars.spaceui.one/v1?name=gemini&variant=kendo',
    total: '$459.97',
    status: {
      label: 'Shipped',
  ...
  },
  {
    ...
    customerAvatar: 'https://avatars.spaceui.one/v1?name=luna&variant=lumina',
    total: '$249.48',
    status: {
      label: 'Processing',
      variant: 'info-light',
  ...
  },
  {
    ...
    customerAvatar: 'https://avatars.spaceui.one/v1?name=mars&variant=shaula',
    total: '$189.97',
    status: {
      label: 'Delivered',
  ...
  },
  {
    ...
    customerAvatar: 'https://avatars.spaceui.one/v1?name=jupiter&variant=singularity',
    total: '$299.97',
    status: {
      label: 'Cancelled',
  ...
  },
  {
    ...
    customerAvatar: 'https://avatars.spaceui.one/v1?name=saturn&variant=triton',
    total: '$179.97',
    status: {
      label: 'Pending',
  ...
  },
  {
    ...
    customerAvatar: 'https://avatars.spaceui.one/v1?name=venus&variant=solar-flare',
    total: '$329.95',
    status: {
      label: 'Shipped',
      variant: 'primary-light',
  ...
  },
  {
    ...
    customerAvatar: 'https://avatars.spaceui.one/v1?name=mercury&variant=titan',
    total: '$159.96',
    status: {
      label: 'Processing',
      variant: 'info-light',
  ...
  },
  {
    ...
    customerAvatar: 'https://avatars.spaceui.one/v1?name=pluto&variant=glass',
    total: '$89.97',
    status: {
      label: 'Delivered',
      variant: 'success-light',
  ...
  },
  {
    ...
    customerAvatar: 'https://avatars.spaceui.one/v1?name=neptune&variant=pebble',
    total: '$199.98',
    status: {
      label: 'Cancelled',
      variant: 'destructive-light',
  ...
  },
  {
    ...
    customerAvatar: 'https://avatars.spaceui.one/v1?name=uranus&variant=invader',
    total: '$149.97',
    status: {
      label: 'Pending',
      variant: 'warning-light',
  ...
  },
  {
    ...
    customer: 'Alex Johnson',
    customerEmail: 'alex@example.com',
    customerAvatar: 'https://avatars.spaceui.one/v1?name=earth&variant=kendo',
    total: '$279.96',
    status: {
      label: 'Shipped',
  ...
  },
  {
    ...
    customer: 'Sarah Chen',
    customerEmail: 'sarah@example.com',
    customerAvatar: 'https://avatars.spaceui.one/v1?name=orion&variant=lumina',
    total: '$119.97',
    status: {
      label: 'Processing',
      variant: 'info-light',
  ...
  },
  {
    ...
    customer: 'Michael Rodriguez',
    customerEmail: 'michael@example.com',
    customerAvatar: 'https://avatars.spaceui.one/v1?name=lyra&variant=shaula',
    total: '$89.98',
    status: {
      label: 'Delivered',
      variant: 'success-light',
  ...
  },
  {
    ...
    customer: 'Emma Wilson',
    customerEmail: 'emma@example.com',
    customerAvatar: 'https://avatars.spaceui.one/v1?name=vega&variant=singularity',
    total: '$199.97',
    status: {
      label: 'Shipped',
      variant: 'primary-light',
  ...
  },
  {
    ...
    customer: 'David Kim',
    customerEmail: 'david@example.com',
    customerAvatar: 'https://avatars.spaceui.one/v1?name=sirius&variant=triton',
    total: '$159.96',
    status: {
      label: 'Pending',
      variant: 'warning-light',
...
export default function Pattern() {
  ...
  const [columnOrder, setColumnOrder] = useState<string[]>(['expand', 'customer', 'items', 'total', 'status'])
          ...
          return (
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-px">
                <div className="text-foreground font-medium">{row.original.customer}</div>
