...
import { IconUser, IconMail, IconMapPinCheck } from '@tabler/icons-react'
    ...
    () => [
      {
        accessorKey: 'name',
        id: 'name',
        header: ({ column }) => <DataGridColumnHeader title="User" icon={<IconUser />} column={column} />,
        cell: ({ row }) => {
          return (
      ...
      {
        accessorKey: 'email',
        header: ({ column }) => <DataGridColumnHeader title="Email" icon={<IconMail />} column={column} />,
        cell: (info) => (
      ...
      },
      {
        ...
        header: ({ column }) => <DataGridColumnHeader title="Location" icon={<IconMapPinCheck />} column={column} />,
        cell: ({ row }) => {
          return (
