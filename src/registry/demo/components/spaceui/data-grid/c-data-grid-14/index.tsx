...
} from '@/registry/components/spaceui/data-grid/data-grid-table-dnd-rows'
  ...
  const columns = useMemo<ColumnDef<IData>[]>(
    () => [
      ...
      },
      {
        ...
        header: 'Email',
        cell: (info) => (
          <a href={`mailto:${info.getValue()}`} className="hover:text-primary text-truncate hover:underline">
