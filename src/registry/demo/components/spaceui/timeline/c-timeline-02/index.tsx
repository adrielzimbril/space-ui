...
const roadmap = [
  {
    ...
    description: 'Deep integration of advanced LLMs for real-time code generation and context-aware suggestions.',
  },
  {
    id: 2,
    date: 'Feb 2025',
  ...
  },
  {
    ...
    description: 'Role-based access control, SOC2 compliance audit, and enhanced data encryption protocols.',
  },
]
...
export default function Demo() {
  return (
    <Timeline defaultValue={2} className="w-full max-w-md">
      {roadmap.map((item) => (
        <TimelineItem key={item.id} step={item.id} className="sm:group-data-[orientation=vertical]/timeline:ms-32">
          <TimelineHeader>
            <TimelineSeparator />
