...
export default function Pattern({
  ...
  const getFileIcon = (file: File | FileMetadata) => {
    ...
    if (type.includes('pdf')) return <IconFileText className="size-4" />
    if (type.includes('word') || type.includes('doc')) return <IconFileText className="size-4" />
    if (type.includes('excel') || type.includes('sheet')) return <IconFileSpreadsheet className="size-4" />
    if (type.includes('zip') || type.includes('rar')) return <IconFileZip className="size-4" />
