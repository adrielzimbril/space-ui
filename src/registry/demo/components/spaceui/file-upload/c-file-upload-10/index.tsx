...
import { IconPhoto, IconUpload, IconX, IconCloudUpload, IconAlertCircle } from '@tabler/icons-react'
        ...
        {hasImage ? (
          ...
          >
            <div className="bg-primary/10 rounded-full p-4">
              <IconCloudUpload className="text-primary size-8" />
            </div>

            <div className="space-y-2">
              <h3 className="text-lg font-semibold">Upload Cover Image</h3>
              <p className="text-muted-foreground text-sm">Drag and drop an image here, or click to browse</p>
              <p className="text-muted-foreground text-xs">Recommended size: 1200x514px • Max size: 5MB</p>
            </div>
