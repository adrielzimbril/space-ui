...
import { IconX, IconCloudUpload, IconPhoto, IconCircleX, IconAlertCircle } from '@tabler/icons-react'
    ...
    <div className={cn('w-full max-w-4xl', className)}>
      ...
      <div className="mb-6">
        <div className="grid grid-cols-4 gap-2.5">
          ...
          {visibleDefaultImages.map((defaultImg) => (
            ...
            >
              <img src={defaultImg.src} className="rounded-md h-[120px] w-full object-cover" alt={defaultImg.alt} />
      ...
      >
        <CardContent className="text-center">
          ...
          <h3 className="text-2sm text-foreground mb-0.5 font-semibold">Choose a file or drag & drop here.</h3>
