...
import { IconPhoto, IconUpload, IconZoomIn, IconX, IconAlertCircle } from '@tabler/icons-react'
...
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@/registry/primitives/dialog'
    ...
    <div className={cn('w-full max-w-4xl', className)}>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            <IconPhoto className={cn('h-5 w-5', isDragging ? 'text-primary' : 'text-muted-foreground')} />
          </div>
