...
import { EventCalendar, type EventCalendarApi } from '@/registry/components/spaceui/event-calendar/event-calendar'
...
import { addDays, addMinutes, differenceInMinutes, format, setHours, startOfDay, startOfWeek } from 'date-fns'
                  ...
                  {COLORS.map((color) => (
                    <button
                      ...
                      className={cn(
                        ...
                        draft.color === color.value && 'ring-ring ring-2 ring-offset-2',
                      )}
                    />
                  ))}
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Field>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setDraft({ ...draft, startHour: Number(value) })}
                    >
                      <SelectTrigger id="ec-crud-start" size="sm">
                        <SelectValue>{`${String(draft.startHour).padStart(2, '0')}:00`}</SelectValue>
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <Field>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setDraft({ ...draft, duration: Number(value) })}
                    >
                      <SelectTrigger id="ec-crud-duration" size="sm">
                        <SelectValue>
                          {DURATIONS.find((d) => d.value === draft.duration)?.label ?? `${draft.duration} min`}
                        </SelectValue>
                      </SelectTrigger>
                      <SelectContent>
