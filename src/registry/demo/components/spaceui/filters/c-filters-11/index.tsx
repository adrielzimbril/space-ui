...
import { Filters, type Filter, type FilterFieldConfig, type FilterOption } from '@/registry/components/spaceui/filters'
    ...
    () => [
      {
        ...
        loadOptions: async (query: string) => {
          ...
          return q ? cacheRef.current.filter((team) => team.label.toLowerCase().includes(q)) : cacheRef.current
        },
      },
    ],
    [],
