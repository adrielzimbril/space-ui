...
} from '@/registry/components/spaceui/filters'
...
function VirtualizedOptions({ options, highlightedIndex, renderOption }: FilterOptionListRenderProps) {
  ...
  return (
    <div ref={setScrollEl} className="max-h-[300px] overflow-y-auto overscroll-contain px-1">
...
export default function Demo() {
  ...
  const [filters, setFilters] = useState<Filter[]>([createFilter('product', 'is_any_of', ['sku-42', 'sku-1024'])])
  ...
  return (
    <div className="flex grow content-start items-start self-start">
      <Filters filters={filters} fields={fields} onChange={handleFiltersChange} />
    </div>
  )
}
