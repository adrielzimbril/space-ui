...
export async function GET(_req: Request, { params }: { params: Promise<{ slug: string[] }> }) {
  ...
  return new ImageResponse(
    <div tw="relative flex w-full h-full bg-[#0A0A0A]">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 4899.14 783.54" height="45">
        ...
        <div tw="flex flex-row gap-10 w-full justify-between items-end">
          <div tw="flex flex-col">
            <p tw="text-white text-6xl font-medium mb-0" style={{ fontFamily: 'Outfit' }}>
              {page.data.title}
            </p>
            {page.data.description && (
              <p tw="text-white/60 text-2xl mt-6 -mb-2 max-w-2xl" style={{ fontFamily: 'Outfit' }}>
                {page.data.description}
              </p>
            )}
          </div>
          ...
          <div tw="flex ml-6">
            <p tw="text-white/80 text-2xl -mb-2" style={{ fontFamily: 'Outfit' }}>
              spaceui.one
            </p>
          </div>
        </div>
    ...
    </div>,
    {
      fonts: [
        {
          name: 'Geist',
          data: await loadGoogleFont('Geist', `${page.data.description} ${page.data.title} spaceui.one`),
          style: 'normal',
        },
      ],
    },
