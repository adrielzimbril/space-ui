...
base: base
preview:
  name: demo-components-spaceui-c-date-selector-1
  align: start
...
<ComponentPreview name="demo-components-spaceui-c-date-selector-2" />

### With Dialog

<ComponentPreview name="demo-components-spaceui-c-date-selector-3" />

### With i18n Support

<ComponentPreview name="demo-components-spaceui-c-date-selector-4" />
