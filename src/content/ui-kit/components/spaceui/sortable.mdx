...
<ComponentPreview name="demo-components-spaceui-c-sortable-2" className="**:[.preview]:h-auto" align="start" />

### Nested

<ComponentPreview name="demo-components-spaceui-c-sortable-3" className="**:[.preview]:h-auto" align="start" />

### Persist to a backend

<ComponentPreview name="demo-components-spaceui-c-sortable-8" className="**:[.preview]:h-auto" align="start" />
...
<ComponentPreview name="demo-components-spaceui-c-sortable-4" />

### Sortable settings priority with frame

<ComponentPreview name="demo-components-spaceui-c-sortable-5" />

### Sortable sidebar navigation with frame

<ComponentPreview name="demo-components-spaceui-c-sortable-6" />

### Sortable image gallery grid with frame

<ComponentPreview name="demo-components-spaceui-c-sortable-7" />
