...
component: true
base: base
preview: demo-components-spaceui-c-icon-stack-1
---
...
<ComponentPreview name="demo-components-spaceui-c-icon-stack-2" />

### Colors

<ComponentPreview name="demo-components-spaceui-c-icon-stack-3" />

### Icon Badge

<ComponentPreview name="demo-components-spaceui-c-icon-stack-4" />

### Empty State Illustration

<ComponentPreview name="demo-components-spaceui-c-icon-stack-5" className="**:[.preview]:h-auto" />

### Item Media

<ComponentPreview name="demo-components-spaceui-c-icon-stack-6" />
