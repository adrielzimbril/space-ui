...
<ComponentPreview name="demo-components-spaceui-c-event-calendar-2" />

### Event calendar with create and edit dialog

<ComponentPreview name="demo-components-spaceui-c-event-calendar-3" />

### Event calendar with custom event chips

<ComponentPreview name="demo-components-spaceui-c-event-calendar-4" />

### Event calendar with drag-to-book appointments

<ComponentPreview name="demo-components-spaceui-c-event-calendar-5" />
