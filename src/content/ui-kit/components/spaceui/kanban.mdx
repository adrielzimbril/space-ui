...
base: base
preview:
  name: demo-components-spaceui-c-kanban-1
  align: start
...
<ComponentPreview name="demo-components-spaceui-c-kanban-2" className="**:[.preview]:h-auto" align="start" />

### Persist to a backend

<ComponentPreview name="demo-components-spaceui-c-kanban-6" className="**:[.preview]:h-auto" align="start" />
...
<ComponentPreview name="demo-components-spaceui-c-kanban-3" />

### Minimal kanban with stacked frame

<ComponentPreview name="demo-components-spaceui-c-kanban-4" />

### Feature roadmap kanban with progress

<ComponentPreview name="demo-components-spaceui-c-kanban-5" />
