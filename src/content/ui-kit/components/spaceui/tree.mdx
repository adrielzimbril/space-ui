...
<ComponentPreview name="demo-c-tree-02" className="**:[.preview]:h-auto" />

### With Icon

<ComponentPreview name="demo-c-tree-03" className="**:[.preview]:h-auto" />

### With Plus and Minus Icons

<ComponentPreview name="demo-c-tree-04" className="**:[.preview]:h-auto" />
...
<ComponentPreview name="demo-c-tree-05" />

### Organization chart tree with avatars

<ComponentPreview name="demo-c-tree-06" />

### Permissions tree with checkboxes

<ComponentPreview name="demo-c-tree-07" />
