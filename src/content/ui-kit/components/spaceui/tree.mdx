---
title: Tree
description: Displays nested files and folders in an expandable tree view, making it easy to explore multi-level directories.
component: true
base: base
links:
  api: https://headless-tree.lukasbach.com/
preview:
  name: demo-components-spaceui-c-tree-1
  className: '**:[.preview]:h-auto'
---

## Installation

<ComponentInstallation name="components-spaceui-tree" />

## Usage

```tsx
import { Tree, TreeItem, TreeItemLabel } from '@/components/spaceui/tree'
```
...
<ComponentPreview name="demo-components-spaceui-c-tree-2" className="**:[.preview]:h-auto" />

### With Icon

<ComponentPreview name="demo-components-spaceui-c-tree-3" className="**:[.preview]:h-auto" />

### With Plus and Minus Icons

<ComponentPreview name="demo-components-spaceui-c-tree-4" className="**:[.preview]:h-auto" />
...
<ComponentPreview name="demo-components-spaceui-c-tree-5" />

### Organization chart tree with avatars

<ComponentPreview name="demo-components-spaceui-c-tree-6" />

### Permissions tree with checkboxes

<ComponentPreview name="demo-components-spaceui-c-tree-7" />
