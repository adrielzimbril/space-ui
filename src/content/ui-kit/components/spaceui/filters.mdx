...
base: base
preview:
  name: demo-components-spaceui-c-filters-1
  align: start
...
const [filters, setFilters] = useState<Filter[]>([createFilter('priority', 'is_any_of', ['low', 'medium'])])
...
<ComponentPreview name="demo-components-spaceui-c-filters-2" align="start" />

### Trigger Button

<ComponentPreview name="demo-components-spaceui-c-filters-3" align="start" />

### Small Size

<ComponentPreview name="demo-components-spaceui-c-filters-4" align="start" />

### Large Size

<ComponentPreview name="demo-components-spaceui-c-filters-5" align="start" />

### Custom Controls

<ComponentPreview name="demo-components-spaceui-c-filters-6" align="start" />

### Data Grid

<ComponentPreview name="demo-components-spaceui-c-filters-7" className="**:[.preview]:h-auto" align="start" />

### Nuqs

<ComponentPreview name="demo-components-spaceui-c-filters-8" className="**:[.preview]:h-auto" align="start" />

### With i18n Support

<ComponentPreview name="demo-components-spaceui-c-filters-9" align="start" />

### Virtualized Large Lists

<ComponentPreview name="demo-components-spaceui-c-filters-10" align="start" />

### Prefetched Async Options

<ComponentPreview name="demo-components-spaceui-c-filters-11" align="start" />

### Async Server-side Search

<ComponentPreview name="demo-components-spaceui-c-filters-12" align="start" />
