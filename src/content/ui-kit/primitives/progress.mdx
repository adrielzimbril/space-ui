...
preview: demo-primitives-p-progress-1
---
...
<ComponentPreview name="demo-primitives-p-progress-3" />
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-progress-2" description="Progress with label and value" />
</ShowcaseGrid>

### With Label and Value

<ComponentPreview name="demo-primitives-p-progress-2" />
