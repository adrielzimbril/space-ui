...
preview: demo-primitives-p-context-menu-1
---
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-context-menu-2" description="Context menu with link items" />
  <ShowcaseCard name="demo-primitives-p-context-menu-3" description="Nested context menu" />
  <ShowcaseCard name="demo-primitives-p-context-menu-4" description="Context menu with checkbox items" />
  <ShowcaseCard name="demo-primitives-p-context-menu-5" description="Context menu with group labels" />
  <ShowcaseCard name="demo-primitives-p-context-menu-6" description="Context menu with icons" />
  <ShowcaseCard name="demo-primitives-p-context-menu-7" description="Context menu with radio group" />
  <ShowcaseCard name="demo-primitives-p-context-menu-8" description="Context menu with switch checkbox items" />
</ShowcaseGrid>
