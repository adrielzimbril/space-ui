...
preview: demo-primitives-p-accordion-1
---
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-accordion-2" description="Accordion allowing multiple panels open" />
  <ShowcaseCard name="demo-primitives-p-accordion-3" description="Bordered accordion items" />
</ShowcaseGrid>
