...
preview: demo-primitives-p-tooltip-1
---
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-tooltip-2" description="Grouped tooltips" />
  <ShowcaseCard name="demo-primitives-p-tooltip-3" description="Toggle group animated tooltip" />
  <ShowcaseCard name="demo-primitives-p-tooltip-4" description="Vertical group with animated tooltip" />
</ShowcaseGrid>
