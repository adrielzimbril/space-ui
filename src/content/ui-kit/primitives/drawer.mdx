...
preview: demo-primitives-p-drawer-1
---
...
<ComponentPreview name="demo-primitives-p-drawer-2" />
...
<ComponentPreview name="demo-primitives-p-drawer-4" />

### Straight Variant

Standard full-bleed straight drawer without rounded inset margins.

<ComponentPreview name="demo-primitives-p-drawer-5" />
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-drawer-3" description="Drawer with close button" />
  <ShowcaseCard name="demo-primitives-p-drawer-6" description="Scrollable content with terms and conditions" />
  <ShowcaseCard name="demo-primitives-p-drawer-7" description="Nested bottom drawers with centered content" />
  <ShowcaseCard name="demo-primitives-p-drawer-8" description="Nested right drawers with inset variant" />
  <ShowcaseCard name="demo-primitives-p-drawer-9" description="Bottom drawer with snap points" />
  <ShowcaseCard
    name="demo-primitives-p-drawer-10"
    description="Edit profile form with default and bare footer variants"
  />
  <ShowcaseCard name="demo-primitives-p-drawer-11" description="Mobile menu drawer from the left" />
  <ShowcaseCard
    name="demo-primitives-p-drawer-12"
    description="Responsive edit profile: dialog on desktop, drawer on mobile"
  />
  <ShowcaseCard
    name="demo-primitives-p-drawer-13"
    description="Responsive actions menu: menu on desktop, drawer on mobile"
  />
  <ShowcaseCard name="demo-primitives-p-drawer-14" description="Left drawer with swipe area" />
</ShowcaseGrid>
