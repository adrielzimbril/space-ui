...
preview: demo-primitives-p-toast-1
---
...
<ComponentPreview name="demo-primitives-p-toast-6" />
...
<ComponentPreview name="demo-primitives-p-toast-8" />
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-toast-2" description="Stacked toasts with varying content height" />
  <ShowcaseCard name="demo-primitives-p-toast-3" description="Anchored tooltip-style toast after copy" />
  <ShowcaseCard name="demo-primitives-p-toast-4" description="Anchored error toast after async failure" />
  <ShowcaseCard name="demo-primitives-p-toast-5" description="Long-running promise toast with cancel" />
  <ShowcaseCard name="demo-primitives-p-toast-6" description="Deduplicated success toast" />
  <ShowcaseCard name="demo-primitives-p-toast-7" description="Deduplicated error toast" />
  <ShowcaseCard name="demo-primitives-p-toast-8" description="Anchored deduplicated success toast" />
  <ShowcaseCard name="demo-primitives-p-toast-9" description="Anchored deduplicated error toast" />
</ShowcaseGrid>
