...
preview: demo-primitives-p-autocomplete-1
---
...
<ComponentPreview name="demo-primitives-p-autocomplete-2" />
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-autocomplete-3" description="Large autocomplete" />
  <ShowcaseCard name="demo-primitives-p-autocomplete-4" description="Autocomplete with label" />
  <ShowcaseCard
    name="demo-primitives-p-autocomplete-5"
    description="Autocomplete autofilling the input with the highlighted item"
  />
  <ShowcaseCard name="demo-primitives-p-autocomplete-6" description="Autocomplete auto highlighting the first option" />
  <ShowcaseCard name="demo-primitives-p-autocomplete-7" description="Autocomplete with clear button" />
  <ShowcaseCard name="demo-primitives-p-autocomplete-8" description="Autocomplete with trigger and clear buttons" />
  <ShowcaseCard name="demo-primitives-p-autocomplete-9" description="Autocomplete with grouped items" />
  <ShowcaseCard name="demo-primitives-p-autocomplete-10" description="Autocomplete with limited number of results" />
  <ShowcaseCard name="demo-primitives-p-autocomplete-11" description="Autocomplete with async items loading" />
  <ShowcaseCard name="demo-primitives-p-autocomplete-12" description="Autocomplete form" />
  <ShowcaseCard name="demo-primitives-p-autocomplete-13" description="Autocomplete form" />
  <ShowcaseCard name="demo-primitives-p-autocomplete-14" description="Pill-shaped autocomplete" />
  <ShowcaseCard
    name="demo-primitives-p-autocomplete-15"
