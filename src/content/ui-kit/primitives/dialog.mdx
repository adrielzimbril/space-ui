...
preview: demo-primitives-p-dialog-1
---
...
<ComponentPreview name="demo-primitives-p-dialog-6" />
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-dialog-2" description="Dialog opened from menu" />
  <ShowcaseCard name="demo-primitives-p-dialog-3" description="Nested dialogs" />
  <ShowcaseCard name="demo-primitives-p-dialog-4" description="Dialog with close confirmation" />
  <ShowcaseCard name="demo-primitives-p-dialog-5" description="Dialog with long content" />
</ShowcaseGrid>
