...
preview: demo-primitives-p-menu-1
---
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-menu-2" description="Menu with hover" />
  <ShowcaseCard name="demo-primitives-p-menu-3" description="Menu with checkbox" />
  <ShowcaseCard name="demo-primitives-p-menu-4" description="Menu with radio group" />
  <ShowcaseCard name="demo-primitives-p-menu-5" description="Menu with link" />
  <ShowcaseCard name="demo-primitives-p-menu-6" description="Menu with group labels" />
  <ShowcaseCard name="demo-primitives-p-menu-7" description="Nested menu" />
  <ShowcaseCard name="demo-primitives-p-menu-8" description="Menu close on click" />
  <ShowcaseCard name="demo-primitives-p-menu-9" description="Menu with checkbox items as switches" />
</ShowcaseGrid>
