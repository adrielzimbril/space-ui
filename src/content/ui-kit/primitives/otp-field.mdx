...
preview: demo-primitives-p-otp-field-1
---
...
<ComponentPreview name="demo-primitives-p-otp-field-2" />

### With Separator

OTP field divided into separated slot groups using `OtpFieldSeparator`.

<ComponentPreview name="demo-primitives-p-otp-field-3" />
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-otp-field-4" description="OTP field with label" />
  <ShowcaseCard name="demo-primitives-p-otp-field-5" description="OTP field with custom sanitization" />
  <ShowcaseCard name="demo-primitives-p-otp-field-6" description="OTP field with auto validation" />
  <ShowcaseCard name="demo-primitives-p-otp-field-7" description="Alphanumeric OTP field" />
  <ShowcaseCard name="demo-primitives-p-otp-field-8" description="OTP field with placeholder hints" />
  <ShowcaseCard name="demo-primitives-p-otp-field-9" description="Masked OTP field" />
</ShowcaseGrid>
