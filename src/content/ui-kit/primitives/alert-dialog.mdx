...
preview: demo-primitives-p-alert-dialog-1
---
...
<ComponentPreview name="demo-primitives-p-alert-dialog-2" />
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-dialog-4" description="Alert dialog with close confirmation" />
</ShowcaseGrid>
