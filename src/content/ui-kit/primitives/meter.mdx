...
preview: demo-primitives-p-meter-1
---
...
<ShowcaseGrid showLayoutToggle={false} columns={1}>
  <ShowcaseCard name="demo-primitives-p-meter-2" description="Simple meter" />
  <ShowcaseCard name="demo-primitives-p-meter-3" description="Meter with formatted value" />
  <ShowcaseCard name="demo-primitives-p-meter-4" description="Meter with range" />
</ShowcaseGrid>
